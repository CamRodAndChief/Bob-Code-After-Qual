...
public class AutoBlue2 extends LinearOpMode { //Locate Special Object
    ...
    boolean AlternateHubRoute = false;
...
//                Level=BarCodeLevels[0];
        ...
        telemetry.addData("Current Auto", "BLUE closest to WAREHOUSE");
        telemetry.addLine(" ");
        telemetry.addLine(" ");
        telemetry.addLine(" ");
...
//            telemetry.update();
        ...
        Step++;
        //if(TOF_Back.getDistance(DistanceUnit.CM) > 150) {
        drive(-100, 0.25);
//        Lid.setPosition(closed);
//        LidOpen = false;
