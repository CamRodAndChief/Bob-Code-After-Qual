...
public class AutoRed1 extends LinearOpMode { //Locate Special Object
    ...
    public void runOpMode() {
        ...
        telemetry.addLine(" ");
        telemetry.addLine(" ");
        telemetry.addData("Object Detection", TOF_Left.getDistance(DistanceUnit.CM));
        telemetry.addLine(" ");
        ...
        if(TOF_Left.getDistance(DistanceUnit.CM) < GapDist){
            GapFree = false;
            BotNoAuto = true;
        }else{
            BotNoAuto = false;
        ...
        if(GapFree){
            ...
            turn(-90, 0.5);
            crab(300, 0.5);
            if(TOF_Left.getDistance(DistanceUnit.CM) < 800){
                LeftSensor = true;
            }else{
                LeftSensor = false;
            }
